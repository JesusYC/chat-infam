<div class="col-lg-4">
	...
	?>
		<div class="panel-heading"><center><strong>Administrar clases <span class="badge"><?php echo $numme; ?></span></strong></center></div>
							...
							<td>
								<?php
									...
									if (mysqli_num_rows($memb)>0){
										?>
										<button type="button" class="btn btn-danger btn-sm delete2" value="<?php echo $myrow['chatroomid']; ?>">Eliminar</button>
										<?php
									}
									else{
										?>
										<button type="button" class="btn btn-warning btn-sm leave2" value="<?php echo $myrow['chatroomid']; ?>">Dejar</button>
										<?php
									}
								?>
							</td>
