<div class="col-lg-8">
    <div class="panel panel-default" style="height:50px;">
		<span style="font-size:18px; margin-left:10px; position:relative; top:13px;"><strong><span class="glyphicon glyphicon-list"></span> Lista de las clases</strong></span>
	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom">
        <thead>
            <tr>
				...
				<th><span class="glyphicon glyphicon-lock"></span> Contraseña || <span class="glyphicon glyphicon-user"></span> Miembro</th>
			</tr>
		</thead>
		<tbody>
		<?php
			...
			<tr>
				...
				<td><button value="<?php echo $row['chatroomid']; ?>" class="btn btn-info join_chat"><span class="glyphicon glyphicon-comment"></span> Unirse</button> &nbsp;
					<?php
					if (!empty($row['chat_password'])){
