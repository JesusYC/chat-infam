				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['userid']==$_SESSION['id']){
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Inicio</a>
							<a href="#delete_room" data-toggle="modal" class="btn btn-danger">Borrar clase</a>
							<a href="#add_member" data-toggle="modal" class="btn btn-primary">Añadir miembro</a>
							<?php
						}
						else{
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Inicio</a>
							<a href="#leave_room" data-toggle="modal" class="btn btn-warning">Dejar clase</a>
							<?php
						}
					?>
				</div>
